...
{	
	...
	*/
	...
	/** Permet d'obtenir la largeur saisie pour la carte
	* @return la largeur saisie pour la carte
	*/
	...
	/** Permet d'obtenir la hauteur saisie pour la carte
	* @return la hauteur saisie pour la carte
	*/
	...
	/** Permet d'obtenir la largeur saisie pour les tiles
	* @return la largeur saisie pour les tiles
	*/
	...
	/** Permet d'obtenir la hauteur saisie pour les tiles
	* @return la hauteur saisie pour les tiles
	*/
