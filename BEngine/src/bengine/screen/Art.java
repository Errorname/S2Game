...
import bengine.BComponent;

public class Art {
	public static Bitmap titleScreen = load("/TITLESCREEN.png");
	public static Bitmap boobie = load("/boobie.png");
    ...
    private static Bitmap[][] cut(String string, int w, int h, int bx, int by) {
        try {
            BufferedImage bi = ImageIO.read(BComponent.class.getResource(string));
