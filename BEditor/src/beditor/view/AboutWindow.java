...
{	
	...
	private final Dimension WINDOW_SIZE = new Dimension(400, 175);
	...
	*/
	...
	{		
		...
		this.text = new JLabel("<html><center><b>BEditor version " + VERSION + " by " + AUTHOR + " (" + YEAR + ")</b><br/><br/>BEditor is an editor to create maps working with BEngine<br/><br/>This program is a part of a project for Nantes Institute of Technology<br/></center></html>");
