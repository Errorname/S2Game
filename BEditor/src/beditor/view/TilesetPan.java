...
public class TilesetPan extends JPanel
{
	...
	private final String TILESET_NOT_FOUND_MSG = "The tileset's image has not been found";
	private final String TILESET_NOT_FOUND_TITLE = "Error";
	...
	public TilesetPan(String tilesetPath, Dimension tileSize, EditorPan editorPan)
	{
		if(tilesetPath != "")
		{
			...
			catch(Exception e)
			{
    			...
    			errorMsg.showMessageDialog(this.editorPan.getMainWindow(), TILESET_NOT_FOUND_MSG, TILESET_NOT_FOUND_TITLE, JOptionPane.ERROR_MESSAGE);
			}
		}
	}
